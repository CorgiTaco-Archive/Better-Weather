...
//
//    public static final EntityType<TornadoEntity> TORNADO = EntityType.Builder.<TornadoEntity>create(TornadoEntity::new, EntityClassification.MISC).size(0.01F, 100F).trackingRange(6).build(BetterWeather.MOD_ID + ":tornado");
//
//
//    @SubscribeEvent
