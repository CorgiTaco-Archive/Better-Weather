...
public final class BWSeason implements Season {
    ...
    public BWSeason setPhaseForTime(long currentYearTime, int yearLength) {
        int seasonTimeOffset = Season.getSeasonStartTime(key, yearLength);
        long seasonLocalTime = currentYearTime - seasonTimeOffset;
