                ...
                if (world != null && minecraft.player != null) {
                    ...
                    if (weatherEventContext == null) {
                        weatherEventContext = ((BetterWeatherWorldData) world).setWeatherEventContext(new BWWeatherEventContext(message.bwWeatherEventContext.getCurrentWeatherEventKey(),
                                message.bwWeatherEventContext.isWeatherForced(), new ArrayList<>(message.bwWeatherEventContext.getForecast()), world.getDimensionKey().getLocation(), world.func_241828_r().getRegistry(Registry.BIOME_KEY), message.bwWeatherEventContext.getWeatherEvents()));
