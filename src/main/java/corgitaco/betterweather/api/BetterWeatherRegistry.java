...
public class BetterWeatherRegistry {
    ...
    public static final Registry<Codec<? extends WeatherEventClient>> CLIENT_WEATHER_EVENT = RegistryAccess.invokeCreateRegistry(CLIENT_WEATHER_EVENT_KEY, () -> WeatherEventClient.CODEC);
}
