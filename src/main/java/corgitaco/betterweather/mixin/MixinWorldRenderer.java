                    ...
                    if (biome.getPrecipitation() != Biome.RainType.NONE) {
                        ...
                        if (floorYMinusGraphicsQuality != floorYPlusGraphicsQuality) {
                            ...
                            //This is snow rendering.
                                ...
                                int j4 = (l3 * 3 + 240) / 4;
                                int k4 = (i4 * 3 + 240) / 4;
                                bufferbuilder.pos((double)graphicQualityX - xIn - rainSizeX + 0.5D, (double)floorYPlusGraphicsQuality  - yIn, (double)graphicQualityZ - zIn - rainSizeZ + 0.5D).tex(0.0F + f7, (float)floorYMinusGraphicsQuality * 0.25F - Math.abs(fallSpeed)).color(1.0F, 1.0F, 1.0F, ticksAndPartialTicks0).lightmap(k4, j4).endVertex();
                                bufferbuilder.pos((double)graphicQualityX - xIn + rainSizeX + 0.5D, (double)floorYPlusGraphicsQuality  - yIn, (double)graphicQualityZ - zIn + rainSizeZ + 0.5D).tex(1.0F + f7, (float)floorYMinusGraphicsQuality * 0.25F - Math.abs(fallSpeed)).color(1.0F, 1.0F, 1.0F, ticksAndPartialTicks0).lightmap(k4, j4).endVertex();
                                bufferbuilder.pos((double)graphicQualityX - xIn + rainSizeX + 0.5D, (double)floorYMinusGraphicsQuality - yIn, (double)graphicQualityZ - zIn + rainSizeZ + 0.5D).tex(1.0F + f7, (float)floorYPlusGraphicsQuality  * 0.25F - Math.abs(fallSpeed)).color(1.0F, 1.0F, 1.0F, ticksAndPartialTicks0).lightmap(k4, j4).endVertex();
                                bufferbuilder.pos((double)graphicQualityX - xIn - rainSizeX + 0.5D, (double)floorYMinusGraphicsQuality - yIn, (double)graphicQualityZ - zIn - rainSizeZ + 0.5D).tex(0.0F + f7, (float)floorYPlusGraphicsQuality  * 0.25F - Math.abs(fallSpeed)).color(1.0F, 1.0F, 1.0F, ticksAndPartialTicks0).lightmap(k4, j4).endVertex();
//                                bufferbuilder.pos((double)graphicQualityX - xIn - rainSizeX + 0.5D, (double)floorYPlusGraphicsQuality  - yIn, (double)graphicQualityZ - zIn - rainSizeZ + 0.5D).tex(0.0F + f7, (float)floorYMinusGraphicsQuality * 0.25F + f6 + f8).color(1.0F, 1.0F, 1.0F, ticksAndPartialTicks0).lightmap(k4, j4).endVertex();
//                                bufferbuilder.pos((double)graphicQualityX - xIn + rainSizeX + 0.5D, (double)floorYPlusGraphicsQuality  - yIn, (double)graphicQualityZ - zIn + rainSizeZ + 0.5D).tex(1.0F + f7, (float)floorYMinusGraphicsQuality * 0.25F + f6 + f8).color(1.0F, 1.0F, 1.0F, ticksAndPartialTicks0).lightmap(k4, j4).endVertex();
//                                bufferbuilder.pos((double)graphicQualityX - xIn + rainSizeX + 0.5D, (double)floorYMinusGraphicsQuality - yIn, (double)graphicQualityZ - zIn + rainSizeZ + 0.5D).tex(1.0F + f7, (float)floorYPlusGraphicsQuality  * 0.25F + f6 + f8).color(1.0F, 1.0F, 1.0F, ticksAndPartialTicks0).lightmap(k4, j4).endVertex();
//                                bufferbuilder.pos((double)graphicQualityX - xIn - rainSizeX + 0.5D, (double)floorYMinusGraphicsQuality - yIn, (double)graphicQualityZ - zIn - rainSizeZ + 0.5D).tex(0.0F + f7, (float)floorYPlusGraphicsQuality  * 0.25F + f6 + f8).color(1.0F, 1.0F, 1.0F, ticksAndPartialTicks0).lightmap(k4, j4).endVertex();
                            }
                        }
                    }
                }
