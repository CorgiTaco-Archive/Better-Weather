...
//                this.tornadoObjects[idx].rotationPointY = yHeight + Mth.cos(((idx * 1.5F) + ageInTicks) * 0.25F);
//                this.tornadoObjects[idx].rotationPointX = Mth.cos(spinSpeed) * xzDistance;
//                this.tornadoObjects[idx].rotationPointZ = Mth.sin(spinSpeed) * xzDistance;
//                ++spinSpeed;
//            }
//        }
//    }
